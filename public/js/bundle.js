...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function buildIndexesJSSearch(graph) {
        ...
        Object.values(graph.getNodes()).forEach(function (n) {
            switch (n.getLabel()) {
                case 'Group':
                    ...
                    types$2.Groups.push(groupIdxEntry);
                    break;
                case 'Topic':
                    var topicIdxEntry = {
                        id: n.getID(),
                    ...
                    types$2.Topics.push(topicIdxEntry);
                    break;
                case 'Member':
                    var memberIdxEntry = {
                        id: n.getID(),
                    ...
                    types$2.Members.push(memberIdxEntry);
                    break;
                case 'Event':
                    var eventIdxEntry = {
                        id: n.getID(),
                    ...
                    types$2.Events.push(eventIdxEntry);
                    break;
                default:
                    console.log("Node Type not supported in Meetup scenario...!");
                    return false;
        ...
        Object.keys(types$2).forEach(function (k) { return console.log(types$2[k].length + " nodes of type " + k + " registered."); });
    ...
    (function () { return __awaiter(_this, void 0, void 0, function () {
        var tic, mug, toc, indexesLunr, indexesFuse, indexesJSSearch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
